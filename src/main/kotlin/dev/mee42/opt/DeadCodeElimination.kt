...
//    return ast.copy { it.copy(Block(inst.optimizeBlock(it.content.statements))) }
    TODO()
}
...
//        is ComparisonExpression -> (variablesUsed(expression.var1) + variablesUsed(expression.var2))
...
//        is RefExpression -> listOf(expression.variableName)
//    }
//
...
//                VariableAccessExpression(variableName, type, isMutable)
//            }
//            is BlockExpression -> {
...
//            is ComparisonExpression -> ComparisonExpression(var1.optimize(), var2.optimize(), mathType)
...
//            ComparisonExpression(var1.inlineImpure(variable, name), var2.inlineImpure(variable, name), mathType)
//        }
