...
import dev.mee42.parser.XenonFunction
...
//        return _variables.firstOrNull { it.name == name } ?: parent?.getVariable(name) ?: error("Can't find variable $name")
//    }
...
//        }
//        is RefExpression -> {
//            state.getVariable(this.variableName).ref()
//            this
//        }
//    }
//}
